...
export default function AIQuestionModal({ open, onClose, defaultType = 'mcq' }) {
      ...
      <div className="w-full max-w-2xl bg-white rounded shadow-lg p-6">
        ...
        <div className="space-y-3">
          <div>
            ...
            <input type="password" value={apiKey} onChange={e => setApiKey(e.target.value)} className="w-full border px-3 py-2 rounded" placeholder="sk-... (your key)" />
          ...
          <div>
            <label className="block text-sm">Unformatted question</label>
          ...
          <div className="flex justify-end gap-3">
            ...
            <button onClick={handleGenerate} disabled={loading || !selectedTest} className="px-4 py-2 bg-green-600 text-white rounded disabled:opacity-60">{loading ? 'Generating...' : 'Generate & Add'}</button>
          </div>
        </div>
        </div>
